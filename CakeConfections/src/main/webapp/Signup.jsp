            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
               ...
               <!--  <div class="col-md-9 register-right">
                ...
                <form class="mx-1 mx-md-4" action="SignupController" method="post">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="form3Example3c">Contact Number</label>
                      <input type="contact" id="form3Example3c" name="contact" class="form-control" />
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                ...
                <img src="https://images.unsplash.com/photo-1623842529695-f056295fd8e4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Y2FrZSUyMGJhY2tncm91bmR8ZW58MHx8MHx8fDA%3D&w=1000&q=80"
